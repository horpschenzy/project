...
<div class="be-content">
    <div class="page-head">
        <h2 class="page-head-title">Categories
            ...
            <div class="create-cat">
                <a href="/admin/add-category">
                    <button class="btn btn-info">
                        <b><i class="icon mdi mdi-plus"></i></b> Create Category
                    </button>
                </a>
            </div>
            @if (session()->has('msg'))
                    ...
                    <div class="widget widget-tile" style="padding: 0px !important; background-color: #eee !important">
                        @foreach ($cat as $item)
                            <div class="col-xs-12 col-md-3 col-lg-3">
                                ...
                                <a href="/pages/{{ $item->category_slug }}"><img src="{{ asset('/uploads/category/') }}/{{ $item->category_image }}" class="col-xs-12 col-md-3 col-lg-3 cat-img" alt="">
                                <h3 class="cat-title">{{ $item->category_name }}</h3></a>
